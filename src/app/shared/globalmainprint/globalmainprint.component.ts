...
@Component({
  selector: 'app-globalmainprint',
  templateUrl: './globalmainprint.component.html',
  styleUrls: ['./globalmainprint.component.scss']
})
export class GlobalmainprintComponent implements OnInit {
